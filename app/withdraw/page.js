    ...
    <div className="min-h-screen bg-white p-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          <button
            ...
            className={`w-full border-2 rounded p-3 text-left font-bold ${method === 'MTN'? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-300 text-black'}`}
          >
            MTN MOBILE MONEY
          </button>
        ...
        <div>
          <button
            ...
            className={`w-full border-2 rounded p-3 text-left font-bold ${method === 'AIRTEL'? 'border-red-500 bg-red-50 text-red-700' : 'border-gray-300 text-black'}`}
          >
            AIRTEL MOBILE MONEY
          </button>
      ...
      {method && (
        <button
          ...
          disabled={loading}
          className={`w-full py-3 mt-4 rounded font-bold text-lg ${loading? 'bg-gray-400 text-gray-200' : 'bg-red-500 text-white'}`}
        >
